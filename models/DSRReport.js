...
let DSRReport = async()=>{
    return new Promise(async(resolve,reject)=>{
        try{
            ...
            let DSRRecords=await getDSRReport();
...
let getDSRReport=async()=>{
    try{
        console.log(`select account.firstName,account.lastName,membership__c.membership_number__c,
        --Type_N_R__c,
        case
        ...
        and 
        Property__c.sfid='a0Y1y000000EFBNEA4'
        limit 10000
        `)
