...
let findNetSpentAPCTCovers = (outlet_id)=>{
    return new Promise(async(resolve,reject)=>{
        try{
          ...
          from tlcsalesforce.pos_cheque_details__c where length(net_amount__c) > 0 and length(covers__c) > 0 and date_part('year', actual_bill_date__c)= date_part('year',CURRENT_DATE) 
