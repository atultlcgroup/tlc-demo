...
let queryForEOD=async()=>{
    try{
        console.log(`Select  distinct payment__c.membership__r__membership_number__c, payment__c.email__c, firstname, lastname, membershiptype__c.name membership_type_name,
