          ...
          <REQUESTDATA>
           <TALLYMESSAGE xmlns:UDF="TallyUDF">
            <LEDGER NAME="${data.current_name}-${data.member_id__c}" Action= "Create">
             ...
             <CURRENCYNAME>${data.currencyisocode}</CURRENCYNAME> 
             <PINCODE>${data.billingpostalcode}</PINCODE>
             <EMAIL>${data.email__c}</EMAIL>
             <PRIORSTATENAME>${data.billingstate}</PRIORSTATENAME> 
             <COUNTRYNAME>${data.billingcountry}</COUNTRYNAME> 
             ...
             <COUNTRYOFRESIDENCE>${data.billingstate}</COUNTRYOFRESIDENCE> 
             <DESCRIPTION></DESCRIPTION>
             <LEDGERCONTACT>${data.mobile__c}</LEDGERCONTACT>
             <LEDGERMOBILE>${data.mobile__c}</LEDGERMOBILE>
             <GSTTYPE/>
             <APPROPRIATEFOR/>
             <PARTYGSTIN>${data.member_gst_details__c}</PARTYGSTIN> 
             <LEDSTATENAME>${data.billingstate}</LEDSTATENAME> 
             ...
             <LEDMULTIADDRESSLIST.LIST>
              ...
              <PINCODE>${data.billingpostalcode}</PINCODE>
              <PHONENUMBER>${data.mobile__c}</PHONENUMBER>
              <COUNTRYNAME>${data.billingcountry}</COUNTRYNAME>
              <GSTREGISTRATIONTYPE>Regular</GSTREGISTRATIONTYPE>
