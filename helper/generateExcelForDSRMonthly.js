...
let ws2 = wb.addWorksheet(`Monthly Sales Report`);
let style = wb.createStyle({
  ...
  ws2.cell(row, column + 2,row+2, column+10, true).string(`Monthly Sales Report - ${dsrValues[0].program_name}`).style(myStyle);
...
ws2.cell(row, column,row, column+19, true).string(`This is an auto generated Monthly Sales Report of ${dsrValues[0].program_name}.   Please do not reply to this email and contact the Program management team for any questions.  Explanations and Definitions are given below.`).style(myStyleAlignLeft);
row+=2;
column = 2;
