...
<table style="width: 100%; font-size: 11px; background-color: #C4B67E; padding: 4px; margin-bottom: 4px; color:white;">
  ...
  <!--table style="width: 100%;">
    ...
    <div class="arilFont" id="pageFooter" style="font-size: 7px; height:800px; bottom:100px;" ><p><b>
...
const pdf = Promise.promisifyAll(require('html-pdf'));
    let data = await pdf.createAsync(`${htmlStr}`, { footer: { "height": "25mm"},"height": "10.5in","width": "14.5in", filename: `${pdfName}` })
    return pdfName
}
